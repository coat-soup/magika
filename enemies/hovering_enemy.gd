...
func _physics_process(delta: float) -> void:
	...
	var nav_vel : Vector3 = Vector3(global_basis.z.x, nav_dir.y, global_basis.z.z) * speed if can_move and nav_agent.distance_to_target() > stay_range else Vector3.ZERO
